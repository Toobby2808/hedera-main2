...
export const SeatIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export const RideIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export const BellIcon = ({ className = "w-9 h-9" }: { className?: string }) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
